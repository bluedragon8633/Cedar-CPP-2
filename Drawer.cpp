...
void Drawer::resizeWindow(std::string title, int width, int height) {
...
void Drawer::stamp(int x, int y, int width, int height, int drawx, int drawy, bool centerOrigin) {
    block.setTexture(atlas);
